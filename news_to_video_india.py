...
TTS_RATE                    = "+2%"    # was +8% - closer to natural conversational pace; the duration-enforcement retry loop (generate_with_duration_enforcement) adapts to whatever this is automatically, so changing it is safe
VIDEO_WIDTH                 = 1080
VIDEO_HEIGHT                 = 1920
